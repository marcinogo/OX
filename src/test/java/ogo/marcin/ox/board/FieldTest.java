...
public class FieldTest {
  ...
  public void testFieldsEquality(Sign sign1, Sign sign2, boolean equalityResult) {
    ...
    assert
        field1.equals(field2) == equalityResult : String.format("Equality for Fields should be %s",
        equalityResult);
  }
  ...
  public void testHashCodeEquality(Sign sign1, Sign sign2, boolean hashCodeEqualityResult) {
    ...
    assert hashCodeComparisonResult == hashCodeEqualityResult : String
        .format("Comparison for hashCodes " +
  ...
  public void testIfFieldReturnFieldWithNewSign(Sign startingSign, Sign newSign) {
    ...
    assert fieldWithNewValue.equals(new Field(newSign)) : String
        .format("changeSign should return " +
  ...
  public void testIfToStringReturnCorrectString(Sign sign, String toStringResult) {
    ...
    assert field.toString().equals(toStringResult) : String
        .format("Produced string should be %s", toStringResult);
  }
  ...
  public void testIfFieldHaveCorrectNumber(Sign sign, int fieldNumber) {
    ...
    assert field.getFieldNumber() == fieldNumber : String
        .format("Field should have %d field number", fieldNumber);
  }
}
